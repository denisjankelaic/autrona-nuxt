import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, getResponseStatus, setResponseHeaders, setHeaders, sendRedirect, proxyRequest, createError, getRequestHost, getRequestProtocol, getQuery as getQuery$1, setHeader, getHeader, lazyEventHandler, useBase, createApp, createRouter as createRouter$1, toNodeListener, getRouterParam, readBody, getResponseStatusText } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/devalue/index.js';
import destr from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL, hasProtocol, withHttps, withoutProtocol, withLeadingSlash, withoutTrailingSlash, withBase, parsePath, parseQuery, stringifyQuery, encodePath, stringifyParsedURL } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/klona/dist/index.mjs';
import defu, { defuFn, createDefu, defu as defu$1 } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola, createConsola } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/errx/dist/index.js';
import { isVNode, toValue, version, unref } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/vue/index.mjs';
import devalue from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { fileURLToPath } from 'node:url';
import { ipxFSStorage, ipxHttpStorage, createIPX, createIPXH3Handler } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/ipx/dist/index.mjs';
import { isAbsolute } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/pathe/dist/index.mjs';
import { hash } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/denisjankelaic/Documents/Autrona/node_modules/@unhead/shared/dist/index.mjs';
...
const _9894rfI1BJ = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/denisjankelaic/Documents/Autrona";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[{"rel":"icon","type":"image/*","href":"/favicon.svg"}],"style":[],"script":[],"noscript":[],"title":"Autrona"};
...
const _inlineRuntimeConfig = {
  ...
  "nuxt-site-config": {
    "stack": [
      ...
      },
      {
        ...
        "_priority": -10,
        "name": "Autrona",
        "description": "Autrona - Tarptautiniai pervežimai"
      },
      {
        "_priority": -3,
  ...
  "ipx": {
    ...
    "fs": {
      "dir": [
        "/Users/denisjankelaic/Documents/Autrona/public"
      ]
    },
    "http": {
      "domains": []
...
const serverAssets = [{"baseName":"server","dir":"/Users/denisjankelaic/Documents/Autrona/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/denisjankelaic/Documents/Autrona","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/denisjankelaic/Documents/Autrona/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/denisjankelaic/Documents/Autrona/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/denisjankelaic/Documents/Autrona/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/denisjankelaic/Documents/Autrona/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _Y60XsUgzF0 = defineNitroPlugin(async (nitroApp) => {
...
const _e01dBhbj4r = defineNitroPlugin(async (nitroApp) => {
...
const _INit6F = defineEventHandler(async (e) => {
...
const _u9VD8n = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const _bG6E9w = defineEventHandler(async (e) => {
...
const _2bR9uo = defineEventHandler(async (e) => {
...
const _1MgfVR = defineEventHandler(async (e) => {
...
const _w2215P = defineEventHandler(async (e) => {
...
const _ZJj190 = defineEventHandler(async (e) => {
...
const _EUoiYG = defineEventHandler(async (e) => {
...
const _se55a1 = defineEventHandler(async (e) => {
...
const _8lWIWi = lazyEventHandler(() => {
...
const _lazy_IrDnnR = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_IrDnnR, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _INit6F, lazy: false, middleware: true, method: undefined },
  { route: '/__site-config__/debug.json', handler: _u9VD8n, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _bG6E9w, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _2bR9uo, lazy: false, middleware: true, method: undefined },
  { route: '/__robots__/debug.json', handler: _1MgfVR, lazy: false, middleware: false, method: undefined },
  { route: '/__robots__/debug-path.json', handler: _w2215P, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/debug.json', handler: _ZJj190, lazy: false, middleware: false, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _EUoiYG, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _se55a1, lazy: false, middleware: false, method: undefined },
  { route: '/_ipx/**', handler: _8lWIWi, lazy: false, middleware: false, method: undefined },
  { route: '/_fonts/**', handler: _lazy_IrDnnR, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_IrDnnR, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('file:///Users/denisjankelaic/Documents/Autrona/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/denisjankelaic/Documents/Autrona/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
